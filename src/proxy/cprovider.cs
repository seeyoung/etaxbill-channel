...
namespace OpenETaxBill.Channel
{
    ...
    public class CProvider : QChannel
    {
        ...
        private OpenETaxBill.SDK.Communication.WcfClient<OpenETaxBill.Channel.WcfProvider.IProviderService> m_wcf_client = null;

        /// <summary>
        /// 
        /// </summary>
        private OpenETaxBill.Channel.WcfProvider.IProviderService WcfClient
        {
            get
            {
                lock (SyncChannel)
                {
                    ...
                    if (Object.Equals(m_wcf_client, null) == true)
                    {
                        ...
                        m_wcf_client = new OpenETaxBill.SDK.Communication.WcfClient<OpenETaxBill.Channel.WcfProvider.IProviderService>
                        (
                            this.BindingName,
