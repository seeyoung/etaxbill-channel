...
namespace OpenETaxBill.Channel
{
    ...
    public class CMailer : QChannel
    {
        ...
        private OpenETaxBill.SDK.Communication.WcfClient<OpenETaxBill.Channel.WcfMailer.IMailerService> m_wcf_client = null;
            ...
            get
            {
                lock (SyncChannel)
                {
                    ...
                    if (Object.Equals(m_wcf_client, null) == true)
                    {
                        ...
                        m_wcf_client = new OpenETaxBill.SDK.Communication.WcfClient<OpenETaxBill.Channel.WcfMailer.IMailerService>
                            (
                            this.BindingName,
