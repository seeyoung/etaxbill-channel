...
namespace OpenETaxBill.Channel
{
    ...
    public class CSigner : QChannel
    {
        ...
        private OpenETaxBill.SDK.Communication.WcfClient<OpenETaxBill.Channel.WcfSigner.ISignerService> m_wcf_client = null;
            ...
            get
            {
                lock (SyncChannel)
                {
                    ...
                    if (Object.Equals(m_wcf_client, null) == true)
                    {
                        ...
                        m_wcf_client = new OpenETaxBill.SDK.Communication.WcfClient<OpenETaxBill.Channel.WcfSigner.ISignerService>(
                            this.BindingName,
