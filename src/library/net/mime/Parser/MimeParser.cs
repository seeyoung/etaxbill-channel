...
namespace OpenETaxBill.Channel.Library.Net.Mime.Parser
{
    ...
    public class MimeParser
    {
        ...
        private string ParseFrom(string headers)
        {
            using (TextReader r = new StreamReader(new MemoryStream(Encoding.UTF8.GetBytes(headers))))
            {
                ...
                while (line != null)
                {
                    ...
                    {
                        OpenETaxBill.Channel.Library.Net.Mime.Parser.eAddress e = new OpenETaxBill.Channel.Library.Net.Mime.Parser.eAddress(line.Substring(5).Trim());
        ...
        internal ArrayList ParseEntries(MemoryStream _messageStream, int pos, string boundaryID)
        {
            ...
            if (m_entries == null)
            {
                ...
                if (boundaryID.Length > 0)
                {
                    ...
                    {
                        string line = Encoding.UTF8.GetString(_lineData);
        ...
        private string CDecode(string data)
        {
            if (data.IndexOf("=?") > -1)
            {
                ...
                string _type = _parts[1];
                string _datax = _parts[2];
        ...
        /// <returns></returns>
        public static DateTime ParseDateS(string p_date)
        {
            /*
            GMT  -0000
            EDT  -0400
            ...
            */
            ...
            p_date = p_date.Replace("GMT", "-0000");
            p_date = p_date.Replace("EDT", "-0400");
            p_date = p_date.Replace("EST", "-0500");
            p_date = p_date.Replace("CDT", "-0500");
            p_date = p_date.Replace("CST", "-0600");
            p_date = p_date.Replace("MDT", "-0600");
            p_date = p_date.Replace("MST", "-0700");
            p_date = p_date.Replace("PDT", "-0700");
            p_date = p_date.Replace("PST", "-0800");
            ...
            return DateTime.ParseExact(p_date.Trim(), formats, System.Globalization.DateTimeFormatInfo.InvariantInfo, System.Globalization.DateTimeStyles.None);
        }
